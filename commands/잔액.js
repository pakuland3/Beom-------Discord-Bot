...
module.exports = {
    ...
    async execute(message, args) {
        ...
        if (!wjdqh) return message.reply("**오류 ) 등록된 정보가 없어 \"범이야 돈받기\"로 돈을 받아**")
        const t = new Date()
        ...
        const embed = new (require("discord.js")).MessageEmbed()
            ...
            .setTimestamp()
            .setColor("YELLOW")
            .addField("서울전자", `${wjdqh.stocks.seoulJj}개`)
            .addField("응애식품", `${wjdqh.stocks.eungaeFd}개`)
            .addField("국찌", `${wjdqh.stocks.gukcci}개`)
            .addField("선도커피", `${wjdqh.stocks.seondoCf}개`)
