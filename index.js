...
mongoose.connect("input Your mongoose URL",{    
...
client.once('ready', async () => {
    ...
    const interval = {
        ...
        callback: async function () {
            ...
            let seoulJjTotal = new Array //주식 그래프 구현 부분
            ...
            console.log(seoulJjVar)
            console.log(eungaeFdVar)
            console.log(gukcciVar)
            console.log(seondoCfVar)
            console.log("\n\n\n")
